            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
              ...
              <div style={{ position: 'relative', width: '300px' }}>
                <input 
                  type="text" 
                  placeholder="Cari..." 
                  style={{ width: '100%', padding: '10px 16px', borderRadius: '999px', border: '2px solid #955C2E', outline: 'none', fontFamily: 'Fredoka One', color: '#5C3A1E', fontSize: '1.1rem' }}
                />
                <Search style={{ position: 'absolute', right: '14px', top: '10px', color: '#955C2E' }} size={20} />
              </div>
            </div>
            
            <div className="history-table-container" style={{ height: 'auto', minHeight: '500px' }}>
              <div className="history-header" style={{ gridTemplateColumns: '2fr 1fr 1fr 1fr', backgroundColor: '#955C2E', color: 'white' }}>
              ...
              <div className="history-body" style={{ overflowY: 'auto' }}>
                {STUDENTS.map((student) => (
                  <div key={student.id} className="history-row" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', padding: '16px 24px', borderBottom: '2px solid #955C2E', alignItems: 'center', backgroundColor: '#FEF6DF' }}>
